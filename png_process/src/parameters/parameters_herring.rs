...
pub const TEMP_SCORE_K: f64 = 0.5;
...
pub const FISH_MAX_AGE: usize = 15 * 12;
pub const FISH_MAX_MOVE: i64 = 50;
pub const FISH_MIN_MOVE: i64 = 0;
pub const FOOD_SCORE_SPREAD_RANGE: i64 = 5;
pub const LAND_SCORE_SPREAD_RANGE: i64 = 10;
pub const SPAWN_RATE: f64 = 0.5;
pub const OPTIMAL_SPAWN_AGE: usize = 12 * 4;
pub const OPTIMAL_TEMPERATURE_LOW: f64 = 14.0;
pub const OPTIMAL_TEMPERATURE_HIGH: f64 = 15.0;
pub const EATEN_RATE_MIN: f64 = 0.1;
pub const EATEN_RATE_MAX: f64 = 0.15;
